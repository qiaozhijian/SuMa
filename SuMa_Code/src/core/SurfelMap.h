...
public:
    ...
    glow::GlBuffer<Surfel> getDataSurfels() {
        return data_surfels_;
    }

    /** \brief get surfels currently inside the model. **/
    glow::GlBuffer<Surfel> getModelSurfels() {
        return surfels_;
    }
...
protected:
    ...
    public:
        ...
        bool operator==(const SubmapIndex& other) const {
